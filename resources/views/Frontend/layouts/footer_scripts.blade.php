								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="{{ asset('UI/') }}/images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											...
											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{ asset('UI/') }}/images/product-detail-01.jpg">
									...
									<div class="item-slick3" data-thumb="{{ asset('UI/') }}/images/product-detail-02.jpg">
										<div class="wrap-pic-w pos-relative">
											...
											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{ asset('UI/') }}/images/product-detail-02.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>
									...
									<div class="item-slick3" data-thumb="{{ asset('UI/') }}/images/product-detail-03.jpg">
										<div class="wrap-pic-w pos-relative">
											...
											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{ asset('UI/') }}/images/product-detail-03.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>
...
<!--===============================================================================================-->
	...
	<script src="{{ asset('UI/js/map-custom.js') }}"></script>
