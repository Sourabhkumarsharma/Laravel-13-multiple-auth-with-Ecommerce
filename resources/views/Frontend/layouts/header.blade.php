...
<header>
		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->		
					<a href="#" class="logo">
						<img src="{{ asset('UI/images/icons/logo-01.png') }}" alt="IMG-LOGO">
					</a>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="{{route('/')}}"><img src="{{ asset('UI/') }}/images/icons/logo-01.png" alt="IMG-LOGO"></a>
			</div>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				<li>
					<a href="{{route('/')}}">Home</a>
					<ul class="sub-menu-m">
						<li><a href="{{route('/')}}">Homepage 1</a></li>
		...
		<div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
			<div class="container-search-header">
				<button class="flex-c-m btn-hide-modal-search trans-04 js-hide-modal-search">
					<img src="{{ asset('UI/') }}/images/icons/icon-close2.png" alt="CLOSE">
				</button>
